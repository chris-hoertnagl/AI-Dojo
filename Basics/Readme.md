...
## Project Overview
We have created a Jupyter Notebook, named `GoldenGateEstate_DataAnalysis.ipynb`, that takes you through our journey of understanding, analyzing, and modeling data for a fictional company, Golden Gate Estate. The primary objective of this project is to predict house prices within the estate.
